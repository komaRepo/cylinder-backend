...
public enum ResultCodeEnum implements BaseErrorInfo {
    ...
    ROLE_NOT_EXIST_OR_FORBIDDEN(1013, "角色不存在或无权操作"),
    PERMISSION_CODE_EXISTS(1014, "该权限代码已存在，请勿重复添加"),
    PARENT_COMPANY_NOT_EXIST(1015, "指定的上级企业不存在，请检查数据"),
    PHONE_ALREADY_REGISTERED(1016, "该手机号已被注册"),
    USERNAME_ALREADY_TAKEN(1017, "该用户名已被占用"),
    COMPANY_DISABLED(1018, "所选企业当前处于禁用状态，无法注册"),
    USER_NOT_FOUND(1019, "该用户不存在"),
    ACCOUNT_NOT_PENDING(1020, "该账号不是待激活状态，无法执行此操作"),
    ACTIVATE_OTHER_COMPANY_FORBIDDEN(1021, "严重警告：您无权激活其他企业的员工账号！"),
